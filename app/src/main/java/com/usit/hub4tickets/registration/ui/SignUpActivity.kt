...
import com.usit.hub4tickets.dashboard.ui.Constants
import com.usit.hub4tickets.dashboard.ui.FetchAddressIntentService
    ...
    private inner class AddressResultReceiver internal constructor(
        ...
        override fun onReceiveResult(resultCode: Int, resultData: Bundle) {
            ...
            if (resultCode == Constants.SUCCESS_RESULT) {
                Toast.makeText(this@SignUpActivity, R.string.address_found, Toast.LENGTH_SHORT).show()
            }
